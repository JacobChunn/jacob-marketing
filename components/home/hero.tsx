...
export default function Hero() {
  return (
    <Flex
      ...
      padding={{base: "20% 10% 50% 10%", small: "20% 10% 50% 10%", medium: "15% 10% 15% 10%"}}
      //backgroundColor={"#00a400"}
      backgroundImage="url('/home/home_hero.avif')" // set your image path here
      style={{ 
      ...
      >
        ...
        >
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
          >
            Need help marketing your business? Contact us today!
          </Text>
